...
export async function getNearestTourismPOI(latitude, longitude) {
  var url = 'https://tourism.opendatahub.com/v1/ODHActivityPoi?latitude={{LAT}}&longitude={{LNG}}&radius={{RADIUS}}&type={{TYPE}}&active=true&origin=webcomp-beacons-map-table' 
